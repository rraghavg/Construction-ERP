...
export const ActionDock = memo(function ActionDock() {
  const { showToast, activePermissions } = useApp();
  ...
  const handleActionClick = (actionName) => {
    ...
    showToast(`Triggered dock action: ${actionName}`, 'info');
  };
      ...
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          <button
            ...
            onClick={() => handleActionClick('Submit RFI')}
          ...
          <button
            ...
            onClick={() => handleActionClick('Purchase Order')}
          ...
          <button
            className="dock-action-btn"
            onClick={() => handleActionClick('Update Progress')}
